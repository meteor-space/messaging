...
defineTypeWithFields = (BaseType, namespace, className, fields) ->
  ...
  definedSerializable = {}
  definedSerializable[classPath] = SubType
  return definedSerializable
...
Space.messaging.define = (BaseType, options..., definitions) ->
  ...
  definedSerializables = {}
  _.extend definedSerializables, defineTypeWithFields(BaseType, namespace, className, fields) for className, fields of definitions
  return definedSerializables
